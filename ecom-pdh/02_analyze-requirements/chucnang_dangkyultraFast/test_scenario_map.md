...
| SC-DANGKYUF-006 | SĐT < 10 số — sai định dạng | REQ-DANGKYUF-003 | DOC-UF-02, Row 3 | User đang ở màn hình Checkout | User nhập SĐT ít hơn 10 số (VD: 090123456 — 9 số) | Hiển thị lỗi "Số điện thoại không hợp lệ."; border đỏ quanh textbox | P2 | Negative |
| SC-DANGKYUF-007 | SĐT không bắt đầu bằng 0 — sai định dạng | REQ-DANGKYUF-003 | DOC-UF-02, Row 3 | User đang ở màn hình Checkout | User nhập SĐT 10 số nhưng không bắt đầu bằng 0 (VD: 1901234567) | Hiển thị lỗi "Số điện thoại không hợp lệ."; border đỏ quanh textbox | P2 | Negative |
