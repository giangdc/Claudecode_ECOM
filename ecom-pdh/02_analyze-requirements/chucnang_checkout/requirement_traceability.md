...
| CLA-CKCOMMON-004 | REQ-CKCOMMON-005 | Thông tin chung R39-40 | Text lỗi SĐT sai định dạng dùng text nào? | **"Số điện thoại không đúng"** (đây là text đúng cho màn chung) | ✅ Resolved | SC-CKCOMMON-014,015 dùng "Số điện thoại không đúng" |
